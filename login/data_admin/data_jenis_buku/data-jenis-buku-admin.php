...
function cari($keyword) {
    $query = "SELECT * FROM jenis WHERE nama_jenis  LIKE '%$keyword%' ";
    return query($query);
}
    ?>
...
$dimas = query("SELECT * FROM jenis ORDER BY id_jenis DESC");
...
<div class="container">
<div class="card">
  <h5 class="card-header ">JENIS BUKU</h5>
  <div class="card-body">
  <a class="btn btn-success position-relative m-2" href="tambah_data.php" role="button" ><i class="bi bi-plus-square"></i> Tambah Jenis Buku</a>
...
<table class="table table-striped table-bordered">
    ...
    <?php foreach( $dimas as $row) : ?>
       <tr>
        ...
        <td>
        <a class="btn btn-success" href="update_data.php?id_jenis=<?= $row["id_jenis"]; ?>" role="button" ><i class="bi bi-pencil-square"></i></a> 
          <a class="btn btn-success btn btn-danger"   href="hapus_data1.php?id_jenis=<?= $row["id_jenis"]; ?>" onclick="return confirm('yakin ingin menghapus ini?');"><i class="bi bi-trash3-fill"></i></a>
          </td> 
       </tr> 
