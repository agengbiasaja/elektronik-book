...
<li class="nav-item dropdown">
    ...
    <?php } ?>
        ...
        <li class="nav-item">
          <a class="nav-link " aria-current="page" href="pustaka.php"></a>
	  ...
	  <!-- search -->
	  <form class="d-flex" role="search" action="data-buku-belum-login.php" method=" ">
      <a class="navbar-brand" href="login/login.php">LOGIN <i class="bi bi-box-arrow-left"></i></a>
